...
class AProjectionBP : public GraphSolver
{
public:
    AProjectionBP():KUpdate(1){};                                                           // DONE
    AProjectionBP(FactorGraph newGraph):KUpdate(1){UseGraph(newGraph);};                    // DONE
    AProjectionBP(int KParam):KUpdate(KParam){};                                            // DONE
    AProjectionBP(FactorGraph newGraph,int KParam):KUpdate(KParam){UseGraph(newGraph);};    // DONE                                 // DONE
    ~AProjectionBP(){};                                                                     // DONE
    string IDString(){return string("AProjectionBP");};
    string PrintParams();
