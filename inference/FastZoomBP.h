...
class FastZoomBP : public GraphSolver
{
public:
    FastZoomBP():QuantFnToVar(1),QuantVarToFn(1){};                                         // DONE
    FastZoomBP(FactorGraph newGraph):QuantFnToVar(1),QuantVarToFn(1){UseGraph(newGraph);};  // DONE
    ~FastZoomBP(){};                                                                        // DONE
    string IDString(){return string("FastZoomBP");};
    string PrintParams();
