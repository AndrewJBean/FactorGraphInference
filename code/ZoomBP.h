...
// unquantized update minimizes 2-norm to desired state, subject to possible directions
...
class ZoomBP : public GraphSolver
{
public:
    ZoomBP():QuantFnToVar(1),QuantVarToFn(1){};                                         // DONE
    ZoomBP(FactorGraph newGraph):QuantFnToVar(1),QuantVarToFn(1){UseGraph(newGraph);};  // DONE
    ~ZoomBP(){};                                                                        // DONE
    string IDString(){return string("ZoomBP");};
    string PrintParams();
